...
class ConfigDialog(QDialog):
    ...
    def setup_ui(self):
        ...
        self.client_id_secret = QLineEdit()
        self.client_id_secret.setPlaceholderText("Seu cliente Secreto")
        self.client_id_secret.setEchoMode(QLineEdit.Password)

        form_layout.addRow("Client ID: ", self.client_id_input)
        form_layout.addRow("Client Secret: ",self.client_id_secret)
        ...
        ok_bttn = QPushButton("Conectar")
        ok_bttn.clicked.connect(self.accept)

        cancel_bttn = QPushButton("Cancelar")
        cancel_bttn.clicked.connect(self.reject)

        buttons_layout.addWidget(ok_bttn)
        buttons_layout.addWidget(cancel_bttn)
